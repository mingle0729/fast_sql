...
class MemberWriteServiceTest {
    ...
    public void testChangeName() {
        ...
        service.changNickname(saved.getId(), expected);
    ...
    public void testToSaveHistoryWhenChangeName() {
        ...
        service.changNickname(member.getId(), nameToChange);
        var results = memberNicknameHistoryRepository.findById(member.getId());
